...
import { getImageGeometry, pointerToNativeCoords, nativeToDisplayStyle, getAbbreviatedPlaceholder, isLineWrappedContinuationBox } from '@/lib/engine/image/imageGeometry';
                ...
                >
                  ...
                  {isImageLoaded &&
                    selections.map((sel) => {
                      ...
                      const isDuplicateWrappedLine = isLineWrappedContinuationBox(sel, selections);
